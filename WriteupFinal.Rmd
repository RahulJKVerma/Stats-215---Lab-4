...
|--------------|-------:|----------|---------|--------|------------|-----------|--------------|--------|
| AUC          | 0.9344 | 0.9043   | 0.8160  | 0.5215 | 0.3334     | 0.2148    | 0.1858       | 0.1928 |
...
Table: Correlation matrix condition on there is cloud, for checking naive Bayes assumption. 
...
|          |Linear |Logistic |naiveBayes |QDA    |NNet   |RForest |LogitCV |LogitPoly |SVM    |
|:---------|:------|:--------|:----------|:------|:------|:-------|:-------|:---------|:------|
|mean AUC  |0.9443 |0.9382   |0.9396     |0.9556 |0.9558 |0.9590  |0.9361  |0.9585    |0.9442 |

Table: Mean AUC for models
...
We see a similar pattern for SVM classification. We have reporduced the table below:

| NDAI|   SD| CORR|   DF|   CF|   BF|   AF|   AN|
|----:|----:|----:|----:|----:|----:|----:|----:|
| 0.00| 0.09| 0.38| 0.74| 0.38| 0.27| 0.23| 0.24|
| 0.07| 0.26| 0.46| 0.28| 0.24| 0.21| 0.16| 0.13|
| 0.28| 0.35| 0.10| 0.20| 0.20| 0.17| 0.20| 0.21|
| 0.12| 0.49| 0.09| 0.04| 0.05| 0.11| 0.04| 0.04|
| 0.20| 0.13| 0.06| 0.01| 0.04| 0.02| 0.26| 0.89|

Table: Table of Classification Error for SVM. The row are quartile of data. For example, the top row entry in the column of NDAI means for the lowest quartile of NDAI value.
