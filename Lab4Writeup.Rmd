...
df = rbind(df1, df2, df3, df4, df5, df6, df8)
...
For this subsection, we focus on logistic regression. We have 27 small images. We fit the 
Logistic model for one small image, get the parameter, add one more image, fit the pararam
